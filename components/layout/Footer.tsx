  ...
  const footerGroups = [
    {
      ...
      title: "COLLECTIONS",
      links: [
        { label: "Teak Sofas", href: "/products?category=sofas" },
        { label: "Teak Diwan Beds", href: "/products?category=diwan-beds" },
        ...
        { label: "Teak Wardrobes", href: "/products?category=wardrobes" },
        { label: "Teak Cabinets", href: "/products?category=cabinet" },
        { label: "Sitout Furniture", href: "/products?category=sitout" },
        { label: "Outdoor Furniture", href: "/products?category=outdoor-furniture" },
